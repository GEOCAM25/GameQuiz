...
const CACHE = "gamequiz-v31";
const ASSETS = ["./","./index.html","./css/style.css","./js/config.js","./js/audio.js","./js/fun.js","./js/crossword.js","./js/karaoke.js","./js/tv.js","./js/theme.js","./js/app.js","./manifest.json"];
